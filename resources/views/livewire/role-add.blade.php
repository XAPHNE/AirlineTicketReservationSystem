<div>
    <title>ATRS Dashboard - Role Add</title>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Role Add</h2>
            <p class="mb-0">Your role adding template.</p>
        </div>
    ...
    <div class="col-12 col-xl-8">
        <div class="card card-body shadow-sm mb-4">
            <h2 class="h5 mb-4">Role information</h2>
                <form wire:submit.prevent="createRole" action="{{route('role.add')}}" method="POST">
                    @csrf
