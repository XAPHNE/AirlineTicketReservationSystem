    ...
    <div class="row">
        <div class="col-12 col-md-4 col-xl-6 mb-4 mb-md-0">
            <p class="mb-0 text-center text-lg-start">© 2019-<span class="current-year"></span> <a
                    class="text-primary fw-normal" href="https://xaphne.github.io" target="_blank">XAPHENE</a>
            </p>
        </div>
        <div class="col-12 col-md-8 col-xl-6 text-center text-lg-start">
            ...
            <ul class="list-inline list-group-flush list-group-borderless text-md-end mb-0">
                <li class="list-inline-item px-0 px-sm-2">
                    <a href="https://xaphne.github.io/about">About</a>
                </li>
                <li class="list-inline-item px-0 px-sm-2">
                    <a href="https://xaphne.github.io/portfolio">Portfolio</a>
                </li>
                <li class="list-inline-item px-0 px-sm-2">
                    <a href="https://xaphne.github.io/blog">Blog</a>
                </li>
                <li class="list-inline-item px-0 px-sm-2">
                    <a href="https://xaphne.github.io/contact">Contact</a>
                </li>
            </ul>
        </div>
    </div>
